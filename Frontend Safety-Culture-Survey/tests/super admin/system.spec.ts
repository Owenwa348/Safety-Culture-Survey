...
test('test', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'ตำแหน่งงาน' }).click();
  await page.getByRole('button', { name: 'สายงาน' }).click();
  await page.getByRole('button', { name: 'กลุ่มงาน' }).click();
  await page.getByRole('button', { name: 'อายุงาน' }).click();
  await page.getByRole('button', { name: 'คำถาม' }).click();
});