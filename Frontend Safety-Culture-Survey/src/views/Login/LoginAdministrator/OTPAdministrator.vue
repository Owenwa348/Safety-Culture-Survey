  ...
  <div class="space-y-6">
    <form @submit.prevent="handleOtpVerification">
      ...
      <div class="space-y-2">
        ...
        <div class="flex justify-center gap-3 my-6">
          <input
            ...
            type="text"
            maxlength="1"
            class="w-12 h-12 text-center text-2xl font-bold border-2 rounded-xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 shadow-sm"
            :class="otpError ? 'border-red-300 bg-red-50' : 'border-gray-300 focus:border-blue-500 hover:border-gray-400'"
          />
        </div>
      ...
      <div class="text-center">
        ...
        <button
          ...
          type="button"
          class="text-sm text-blue-600 hover:text-blue-700 hover:underline font-medium transition-all duration-300 transform hover:scale-105"
        >
      ...
      <button
        ...
        :class="[
          'w-full py-3 px-6 rounded-xl font-semibold text-lg transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-blue-100',
    ...
    <div class="text-center pt-4 border-t border-gray-100">
      <p class="text-xs text-gray-500">
        หากไม่ได้รับรหัส OTP กรุณาตรวจสอบเบอร์โทรศัพท์
      </p>
    </div>
  </div>
</template>
...
<style scoped>
/* Add subtle animation for OTP inputs */
.otp-input {
